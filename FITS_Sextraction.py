...
for s in proc:
    ...
    for light_id in y:
        ...
        " && sex ../" +
        file +
        " -PARAMETERS_NAME sex_outcols.txt -FILTER_NAME gauss_5.0_9x9_conv.txt -STARNNW_NAME default_nnw.txt -c wisesex_params.txt -SATUR_LEVEL 2500 -DETECT_THRESH 2 -GAIN 4.445378 -WEIGHT_GAIN N,N -CATALOG_NAME " +
        sample + '-' + light_id[:-5] +
